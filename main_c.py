...
if __name__ == "__main__":
    ...
    c_lib.omp_block_matching.argtypes = [
    ...
    c_lib.omp_block_matching.restype = ctypes.c_void_p
    ...
    start = time.time()
    c_lib.omp_block_matching(left_ctypes, right_ctypes, out_ctypes, height, width, max_disparity, kernel_size)
    end = time.time()
